...
resource nsgChangeRule 'Microsoft.OperationalInsights/workspaces/providers/alertRules@2023-02-01' = {
  name: '${workspace}/Microsoft.SecurityInsights/${guid('nsg-changes-rule', workspace)}'
  kind: 'Scheduled'
  properties: {
